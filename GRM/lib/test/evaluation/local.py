...
def local_env_settings():
    ...
    settings.network_path = '/data/users/fengtao/GRM/output/test/networks'  # Where tracking networks are stored
    settings.nfs_path = os.path.expanduser('~') + '/track/data/NFS30'
    settings.otb_path = os.path.expanduser('~') + '/track/data/OTB100'
    settings.prj_dir = '/data/users/fengtao/GRM'
    settings.result_plot_path = '/data/users/fengtao/GRM/output/test/result_plots'
    settings.results_path = '/data/users/fengtao/GRM/output/test/tracking_results'  # Where to store tracking results
    settings.save_dir = '/data/users/fengtao/GRM/output'
    ...
    settings.hsitrack_path = '/data/users/fengtao/GRM/data/HSICV'   # Directory for MSI datasets.
