...
class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/data/users/fengtao/GRM'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/data/users/fengtao/GRM/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = '/data/users/fengtao/GRM/pretrained_networks'
        self.hsitrack_dir = '/data/users/fengtao/GRM/data/HSICV'    # Directory for MSI datasets.